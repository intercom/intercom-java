...
public class AsyncNotesClient {
    ...
    public CompletableFuture<SyncPagingIterable<Note>> list(
        ...
        CompletableFuture<SyncPagingIterable<Note>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SyncPagingIterable<Note>(true, result, () -> {
                            try {
    ...
    public CompletableFuture<Note> create(CreateContactNoteRequest request, RequestOptions requestOptions) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Note.class));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    try {
