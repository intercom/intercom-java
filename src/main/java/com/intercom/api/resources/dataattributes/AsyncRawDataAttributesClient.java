...
public class AsyncRawDataAttributesClient {
     ...
     * You can fetch a list of all data attributes belonging to a workspace for contacts, companies or conversations.
     */
    public CompletableFuture<IntercomHttpResponse<DataAttributeList>> list(ListDataAttributesRequest request) {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<DataAttributeList>> list(
            ListDataAttributesRequest request, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<DataAttribute>> create(CreateDataAttributeRequest request) {
     ...
     * You can create a data attributes for a <code>contact</code> or a <code>company</code>.
     */
    public CompletableFuture<IntercomHttpResponse<DataAttribute>> create(
     ...
     * </blockquote>
     */
    public CompletableFuture<IntercomHttpResponse<DataAttribute>> update(UpdateDataAttributeRequest request) {
     ...
     * </blockquote>
     */
    public CompletableFuture<IntercomHttpResponse<DataAttribute>> update(
