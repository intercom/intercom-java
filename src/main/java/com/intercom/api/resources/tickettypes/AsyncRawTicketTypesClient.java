...
public class AsyncRawTicketTypesClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<TicketTypeList>> list() {
        return list(null);
    }
     ...
     * You can get a list of all ticket types for a workspace.
     */
    public CompletableFuture<IntercomHttpResponse<TicketTypeList>> list(RequestOptions requestOptions) {
