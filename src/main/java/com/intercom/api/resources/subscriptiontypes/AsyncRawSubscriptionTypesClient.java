...
public class AsyncRawSubscriptionTypesClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<SubscriptionTypeList>> list() {
        return list(null);
    }
     ...
     * You can list all subscription types. A list of subscription type objects will be returned.
     */
    public CompletableFuture<IntercomHttpResponse<SubscriptionTypeList>> list(RequestOptions requestOptions) {
