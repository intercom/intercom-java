...
public final class UpdateContentImportSourceRequest {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.sourceId, this.syncBehavior, this.status, this.url);
    }
    ...
    public interface SourceIdStage {
         ...
         */
        SyncBehaviorStage sourceId(@NotNull String sourceId);
    ...
    public static final class Builder implements SourceIdStage, SyncBehaviorStage, UrlStage, _FinalStage {
        ...
        public SyncBehaviorStage sourceId(@NotNull String sourceId) {
        ...
        public UpdateContentImportSourceRequest build() {
            return new UpdateContentImportSourceRequest(sourceId, syncBehavior, status, url, additionalProperties);
        }
    }
