...
@JsonDeserialize(builder = DeleteExternalPageRequest.Builder.class)
public final class DeleteExternalPageRequest {
    private final String pageId;

    private final Map<String, Object> additionalProperties;

    private DeleteExternalPageRequest(String pageId, Map<String, Object> additionalProperties) {
        this.pageId = pageId;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteExternalPageRequest && equalTo((DeleteExternalPageRequest) other);
    }
    ...
    private boolean equalTo(DeleteExternalPageRequest other) {
    ...
    public interface PageIdStage {
        ...
        Builder from(DeleteExternalPageRequest other);
    }

    public interface _FinalStage {
        DeleteExternalPageRequest build();
    }
    ...
    public static final class Builder implements PageIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteExternalPageRequest other) {
        ...
        @java.lang.Override
        public DeleteExternalPageRequest build() {
            return new DeleteExternalPageRequest(pageId, additionalProperties);
        }
    }
}
