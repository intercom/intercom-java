...
public class AsyncHelpCentersClient {
    ...
    public CompletableFuture<HelpCenter> find(FindHelpCenterRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<HelpCenter> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), HelpCenter.class));
                        return;
                    }
    ...
    public CompletableFuture<SyncPagingIterable<HelpCenter>> list(
        ...
        CompletableFuture<SyncPagingIterable<HelpCenter>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SyncPagingIterable<HelpCenter>(true, result, () -> {
                            try {
