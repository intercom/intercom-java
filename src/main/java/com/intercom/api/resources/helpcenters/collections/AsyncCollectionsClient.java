...
public class AsyncCollectionsClient {
    ...
    public CompletableFuture<SyncPagingIterable<Collection>> list(
        ...
        CompletableFuture<SyncPagingIterable<Collection>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SyncPagingIterable<Collection>(true, result, () -> {
                            try {
    ...
    public CompletableFuture<Collection> create(CreateCollectionRequest request, RequestOptions requestOptions) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Collection.class));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    try {
    ...
    public CompletableFuture<DeletedCollectionObject> delete(
        ...
        CompletableFuture<DeletedCollectionObject> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
