...
@JsonDeserialize(builder = ListHelpCentersRequest.Builder.class)
public final class ListHelpCentersRequest {
    ...
    private ListHelpCentersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListHelpCentersRequest && equalTo((ListHelpCentersRequest) other);
    }
    ...
    private boolean equalTo(ListHelpCentersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListHelpCentersRequest other) {
            page(other.getPage());
        ...
        public ListHelpCentersRequest build() {
            return new ListHelpCentersRequest(page, perPage, additionalProperties);
        }
    }
}
