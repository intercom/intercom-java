...
public class RawEventsClient {
     ...
     */
    public IntercomHttpResponse<DataEventSummary> list(ListEventsRequest request) {
     ...
     * <p>You can optionally define the result page size as well with the <code>per_page</code> parameter.</p>
     */
    public IntercomHttpResponse<DataEventSummary> list(ListEventsRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new IntercomHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), DataEventSummary.class), response);
            }
     ...
     * </ul>
     */
    public IntercomHttpResponse<Void> create(CreateDataEventRequest request) {
     ...
     * </ul>
     */
    public IntercomHttpResponse<Void> create(CreateDataEventRequest request, RequestOptions requestOptions) {
     ...
     */
    public IntercomHttpResponse<Void> summaries() {
     ...
     * Create event summaries for a user. Event summaries are used to track the number of times an event has occurred, the first time it occurred and the last time it occurred.
     */
    public IntercomHttpResponse<Void> summaries(ListEventSummariesRequest request) {
     ...
     * Create event summaries for a user. Event summaries are used to track the number of times an event has occurred, the first time it occurred and the last time it occurred.
     */
    public IntercomHttpResponse<Void> summaries(ListEventSummariesRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
