...
public class AsyncRawEventsClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<DataEventSummary>> list(ListEventsRequest request) {
     ...
     * <p>You can optionally define the result page size as well with the <code>per_page</code> parameter.</p>
     */
    public CompletableFuture<IntercomHttpResponse<DataEventSummary>> list(
        ...
        if (request.getIntercomUserId().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "intercom_user_id", request.getIntercomUserId().get(), false);
        }
        ...
        if (request.getSummary().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "summary", request.getSummary().get(), false);
        }
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DataEventSummary.class),
                                response));
                        return;
                    }
                    try {
     ...
     * </ul>
     */
    public CompletableFuture<IntercomHttpResponse<Void>> create(CreateDataEventRequest request) {
     ...
     * </ul>
     */
    public CompletableFuture<IntercomHttpResponse<Void>> create(
            CreateDataEventRequest request, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Void>> summaries() {
        return summaries(ListEventSummariesRequest.builder().build());
    }

    /**
     * Create event summaries for a user. Event summaries are used to track the number of times an event has occurred, the first time it occurred and the last time it occurred.
     */
    public CompletableFuture<IntercomHttpResponse<Void>> summaries(ListEventSummariesRequest request) {
        return summaries(request, null);
    }
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Void>> summaries(
            ListEventSummariesRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
