...
public class AsyncRawAdminsClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<ActivityLogList>> listAllActivityLogs(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<AdminList>> list() {
        return list(null);
    }
     ...
     * You can fetch a list of admins for a given workspace.
     */
    public CompletableFuture<IntercomHttpResponse<AdminList>> list(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("admins")
                .build();
