...
public class RawDataExportClient {
    ...
    public IntercomHttpResponse<DataExportExportReportingDataResponse> exportReportingData(
     ...
     * </blockquote>
     */
    public IntercomHttpResponse<Void> downloadReportingDataExport(DownloadReportingDataExportRequest request) {
     ...
     * </blockquote>
     */
    public IntercomHttpResponse<Void> downloadReportingDataExport(
     ...
     * </blockquote>
     */
    public IntercomHttpResponse<DataExport> create(CreateDataExportRequest request) {
     ...
     * </blockquote>
     */
    public IntercomHttpResponse<DataExport> create(CreateDataExportRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new IntercomHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), DataExport.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new IntercomApiException(
                    "Error with status code " + response.code(),
     ...
     * </blockquote>
     */
    public IntercomHttpResponse<DataExport> find(FindDataExportRequest request) {
     ...
     * </blockquote>
     */
    public IntercomHttpResponse<DataExport> find(FindDataExportRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("export/content/data")
                .addPathSegment(request.getJobIdentifier())
     ...
     */
    public IntercomHttpResponse<DataExport> cancel(CancelDataExportRequest request) {
     ...
     * You can cancel your job
     */
    public IntercomHttpResponse<DataExport> cancel(CancelDataExportRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
     ...
     * </blockquote>
     */
    public IntercomHttpResponse<Void> download(DownloadDataExportRequest request) {
     ...
     * </blockquote>
     */
    public IntercomHttpResponse<Void> download(DownloadDataExportRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
