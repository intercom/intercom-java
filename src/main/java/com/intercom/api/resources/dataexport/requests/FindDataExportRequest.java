...
@JsonDeserialize(builder = FindDataExportRequest.Builder.class)
public final class FindDataExportRequest {
    private final String jobIdentifier;

    private final Map<String, Object> additionalProperties;

    private FindDataExportRequest(String jobIdentifier, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FindDataExportRequest && equalTo((FindDataExportRequest) other);
    }
    ...
    private boolean equalTo(FindDataExportRequest other) {
    ...
    public interface JobIdentifierStage {
        ...
        Builder from(FindDataExportRequest other);
    }

    public interface _FinalStage {
        FindDataExportRequest build();
    }
    ...
    public static final class Builder implements JobIdentifierStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(FindDataExportRequest other) {
        ...
        @java.lang.Override
        public FindDataExportRequest build() {
            return new FindDataExportRequest(jobIdentifier, additionalProperties);
        }
    }
}
