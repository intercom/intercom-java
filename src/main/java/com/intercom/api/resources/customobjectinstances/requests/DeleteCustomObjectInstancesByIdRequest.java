...
@JsonDeserialize(builder = DeleteCustomObjectInstancesByIdRequest.Builder.class)
public final class DeleteCustomObjectInstancesByIdRequest {
    ...
    private DeleteCustomObjectInstancesByIdRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteCustomObjectInstancesByIdRequest
                && equalTo((DeleteCustomObjectInstancesByIdRequest) other);
    }
    ...
    private boolean equalTo(DeleteCustomObjectInstancesByIdRequest other) {
    ...
    public interface CustomObjectTypeIdentifierStage {
        ...
        Builder from(DeleteCustomObjectInstancesByIdRequest other);
    }
    ...
    public interface _FinalStage {
        DeleteCustomObjectInstancesByIdRequest build();
    }
    ...
    public static final class Builder implements CustomObjectTypeIdentifierStage, ExternalIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteCustomObjectInstancesByIdRequest other) {
        ...
        public DeleteCustomObjectInstancesByIdRequest build() {
            return new DeleteCustomObjectInstancesByIdRequest(
