...
public class RawTagsClient {
     ...
     */
    public IntercomHttpResponse<Tag> tagContact(TagContactRequest request) {
     ...
     * You can tag a specific contact. This will return a tag object for the tag that was added to the contact.
     */
    public IntercomHttpResponse<Tag> tagContact(TagContactRequest request, RequestOptions requestOptions) {
     ...
     */
    public IntercomHttpResponse<Tag> untagContact(UntagContactRequest request) {
     ...
     * You can remove tag from a specific contact. This will return a tag object for the tag that was removed from the contact.
     */
    public IntercomHttpResponse<Tag> untagContact(UntagContactRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("contacts")
                .addPathSegment(request.getContactId())
     ...
     */
    public IntercomHttpResponse<Tag> tagConversation(TagConversationRequest request) {
     ...
     * You can tag a specific conversation. This will return a tag object for the tag that was added to the conversation.
     */
    public IntercomHttpResponse<Tag> tagConversation(TagConversationRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
     ...
     */
    public IntercomHttpResponse<Tag> untagConversation(UntagConversationRequest request) {
     ...
     * You can remove tag from a specific conversation. This will return a tag object for the tag that was removed from the conversation.
     */
    public IntercomHttpResponse<Tag> untagConversation(
     ...
     */
    public IntercomHttpResponse<Tag> create(TagsCreateRequestBody request) {
     ...
     * <p>Each operation will return a tag object.</p>
     */
    public IntercomHttpResponse<Tag> create(TagsCreateRequestBody request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tags")
                .build();
     ...
     */
    public IntercomHttpResponse<Tag> find(FindTagRequest request) {
     ...
     * This will return a tag object.
     */
    public IntercomHttpResponse<Tag> find(FindTagRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tags")
                .addPathSegment(request.getTagId())
     ...
     */
    public IntercomHttpResponse<Void> delete(DeleteTagRequest request) {
     ...
     * You can delete the details of tags that are on the workspace by passing in the id.
     */
    public IntercomHttpResponse<Void> delete(DeleteTagRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tags")
                .addPathSegment(request.getTagId())
     ...
     */
    public IntercomHttpResponse<Tag> tagTicket(TagTicketRequest request) {
     ...
     * You can tag a specific ticket. This will return a tag object for the tag that was added to the ticket.
     */
    public IntercomHttpResponse<Tag> tagTicket(TagTicketRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
     ...
     */
    public IntercomHttpResponse<Tag> untagTicket(UntagTicketRequest request) {
     ...
     * You can remove tag from a specific ticket. This will return a tag object for the tag that was removed from the ticket.
     */
    public IntercomHttpResponse<Tag> untagTicket(UntagTicketRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tickets")
                .addPathSegment(request.getTicketId())
