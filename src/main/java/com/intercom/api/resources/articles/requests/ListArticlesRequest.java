...
@JsonDeserialize(builder = ListArticlesRequest.Builder.class)
public final class ListArticlesRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListArticlesRequest && equalTo((ListArticlesRequest) other);
    }
    ...
    private boolean equalTo(ListArticlesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListArticlesRequest other) {
            page(other.getPage());
        ...
        public ListArticlesRequest build() {
            return new ListArticlesRequest(page, perPage, additionalProperties);
        }
    }
}
