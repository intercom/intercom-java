...
@JsonDeserialize(builder = DeleteTicketResponse.Builder.class)
public final class DeleteTicketResponse {
    ...
    /**
     * @return Whether the ticket is deleted or not.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteTicketResponse && equalTo((DeleteTicketResponse) other);
    }
    ...
    private boolean equalTo(DeleteTicketResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(DeleteTicketResponse other) {
            id(other.getId());
        ...
        /**
         * <p>Whether the ticket is deleted or not.</p>
         */
        ...
        public DeleteTicketResponse build() {
            return new DeleteTicketResponse(id, object, deleted, additionalProperties);
        }
    }
}
