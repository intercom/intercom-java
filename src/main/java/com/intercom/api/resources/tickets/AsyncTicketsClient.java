...
public class AsyncTicketsClient {
    ...
    public CompletableFuture<TicketReply> reply(ReplyToTicketRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<TicketReply> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TicketReply.class));
                        return;
                    }
    ...
    public CompletableFuture<SyncPagingIterable<Ticket>> search(SearchRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<SyncPagingIterable<Ticket>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SyncPagingIterable<Ticket>(startingAfter.isPresent(), result, () -> {
                            try {
