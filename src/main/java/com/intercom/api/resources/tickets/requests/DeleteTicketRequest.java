...
public final class DeleteTicketRequest {
    private final String ticketId;

    private final Map<String, Object> additionalProperties;

    private DeleteTicketRequest(String ticketId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteTicketRequest && equalTo((DeleteTicketRequest) other);
    }
    ...
    private boolean equalTo(DeleteTicketRequest other) {
    ...
    public interface TicketIdStage {
        ...
        Builder from(DeleteTicketRequest other);
    }

    public interface _FinalStage {
        DeleteTicketRequest build();
    }
    ...
    public static final class Builder implements TicketIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteTicketRequest other) {
        ...
        public DeleteTicketRequest build() {
            return new DeleteTicketRequest(ticketId, additionalProperties);
        }
    }
}
