...
@JsonDeserialize(builder = ShowContactResponse.Builder.class)
public final class ShowContactResponse implements IContact {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ShowContactResponse && equalTo((ShowContactResponse) other);
    }
    ...
    private boolean equalTo(ShowContactResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ShowContactResponse other) {
            type(other.getType());
            id(other.getId());
        ...
        public ShowContactResponse build() {
            return new ShowContactResponse(
                    type,
                    id,
                    externalId,
                    workspaceId,
