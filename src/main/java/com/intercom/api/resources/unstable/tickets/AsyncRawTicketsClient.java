...
public class AsyncRawTicketsClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<TicketReply>> replyTicket(ReplyTicketRequest request) {
     ...
     * You can reply to a ticket with a message from an admin or on behalf of a contact, or with a note for admins.
     */
    public CompletableFuture<IntercomHttpResponse<TicketReply>> replyTicket(
            ReplyTicketRequest request, RequestOptions requestOptions) {
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TicketReply.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Optional<Ticket>>> getTicket(GetTicketRequest request) {
     ...
     * You can fetch the details of a single ticket.
     */
    public CompletableFuture<IntercomHttpResponse<Optional<Ticket>>> getTicket(
            GetTicketRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tickets")
                .addPathSegment(request.getId())
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Optional<Ticket>>> updateTicket(UpdateTicketRequest request) {
     ...
     * You can update a ticket.
     */
    public CompletableFuture<IntercomHttpResponse<Optional<Ticket>>> updateTicket(
     ...
     * | $        | String                         | Ends With                                                    |</p>
     */
    public CompletableFuture<IntercomHttpResponse<TicketList>> searchTickets(SearchRequest request) {
     ...
     * | $        | String                         | Ends With                                                    |</p>
     */
    public CompletableFuture<IntercomHttpResponse<TicketList>> searchTickets(
        ...
        CompletableFuture<IntercomHttpResponse<TicketList>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
