...
@JsonDeserialize(builder = ListAllCompaniesRequest.Builder.class)
public final class ListAllCompaniesRequest {
    ...
    private ListAllCompaniesRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListAllCompaniesRequest && equalTo((ListAllCompaniesRequest) other);
    }
    ...
    public static final class Builder {
        ...
        public ListAllCompaniesRequest build() {
            return new ListAllCompaniesRequest(page, perPage, order, additionalProperties);
        }
    }
}
