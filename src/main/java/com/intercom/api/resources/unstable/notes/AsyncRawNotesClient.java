...
public class AsyncRawNotesClient {
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, NoteList.class), response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<NoteList>> listNotes(ListNotesRequest request) {
     ...
     * You can fetch a list of notes that are associated to a contact.
     */
    public CompletableFuture<IntercomHttpResponse<NoteList>> listNotes(
            ListNotesRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Note>> createNote(CreateNoteRequest request) {
     ...
     * You can add a note to a single contact.
     */
    public CompletableFuture<IntercomHttpResponse<Note>> createNote(
            CreateNoteRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("contacts")
                .addPathSegment(Integer.toString(request.getId()))
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Note>> retrieveNote(RetrieveNoteRequest request) {
     ...
     * You can fetch the details of a single note.
     */
    public CompletableFuture<IntercomHttpResponse<Note>> retrieveNote(
            RetrieveNoteRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("notes")
                .addPathSegment(Integer.toString(request.getId()))
