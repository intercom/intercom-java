...
public class AsyncCompaniesClient {
    ...
    public CompletableFuture<CompanyList> retrieveCompany() {
        return this.rawClient.retrieveCompany().thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<CompanyList> retrieveCompany(RetrieveCompanyRequest request) {
        return this.rawClient.retrieveCompany(request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<CompanyList> retrieveCompany(
        ...
        return this.rawClient.retrieveCompany(request, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Company> createOrUpdateCompany(Object request) {
        return this.rawClient.createOrUpdateCompany(request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Company> createOrUpdateCompany(Object request, RequestOptions requestOptions) {
        return this.rawClient.createOrUpdateCompany(request, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Company> retrieveACompanyById(RetrieveACompanyByIdRequest request) {
        return this.rawClient.retrieveACompanyById(request).thenApply(response -> response.body());
    }

    /**
     * You can fetch a single company.
     */
    public CompletableFuture<Company> retrieveACompanyById(
            RetrieveACompanyByIdRequest request, RequestOptions requestOptions) {
        return this.rawClient.retrieveACompanyById(request, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Company> updateCompany(UpdateCompanyRequest request) {
        return this.rawClient.updateCompany(request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Company> updateCompany(UpdateCompanyRequest request, RequestOptions requestOptions) {
        return this.rawClient.updateCompany(request, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<DeletedCompanyObject> deleteCompany(DeleteCompanyRequest request) {
        return this.rawClient.deleteCompany(request).thenApply(response -> response.body());
    }

    /**
     * You can delete a single company.
     */
    public CompletableFuture<DeletedCompanyObject> deleteCompany(
            DeleteCompanyRequest request, RequestOptions requestOptions) {
        return this.rawClient.deleteCompany(request, requestOptions).thenApply(response -> response.body());
    }
     ...
     */
    public CompletableFuture<CompanyAttachedSegments> listAttachedSegmentsForCompanies(
            ListAttachedSegmentsForCompaniesRequest request) {
        return this.rawClient.listAttachedSegmentsForCompanies(request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<CompanyList> listAllCompanies() {
        return this.rawClient.listAllCompanies().thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<CompanyList> listAllCompanies(ListAllCompaniesRequest request) {
        return this.rawClient.listAllCompanies(request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<CompanyList> listAllCompanies(
        ...
        return this.rawClient.listAllCompanies(request, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Optional<CompanyScroll>> scrollOverAllCompanies() {
        return this.rawClient.scrollOverAllCompanies().thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Optional<CompanyScroll>> scrollOverAllCompanies(ScrollOverAllCompaniesRequest request) {
        return this.rawClient.scrollOverAllCompanies(request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Optional<CompanyScroll>> scrollOverAllCompanies(
        ...
        return this.rawClient.scrollOverAllCompanies(request, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Company> attachContactToACompany(AttachContactToACompanyRequest request) {
        return this.rawClient.attachContactToACompany(request).thenApply(response -> response.body());
    }

    /**
     * You can attach a company to a single contact.
     */
    public CompletableFuture<Company> attachContactToACompany(
            AttachContactToACompanyRequest request, RequestOptions requestOptions) {
        return this.rawClient.attachContactToACompany(request, requestOptions).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Company> detachContactFromACompany(DetachContactFromACompanyRequest request) {
        return this.rawClient.detachContactFromACompany(request).thenApply(response -> response.body());
    }

    /**
     * You can detach a company from a single contact.
     */
    public CompletableFuture<Company> detachContactFromACompany(
            DetachContactFromACompanyRequest request, RequestOptions requestOptions) {
        return this.rawClient.detachContactFromACompany(request, requestOptions).thenApply(response -> response.body());
    }
}
