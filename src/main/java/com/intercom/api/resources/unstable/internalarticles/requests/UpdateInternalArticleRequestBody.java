...
public final class UpdateInternalArticleRequestBody {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.id, this.title, this.body, this.authorId, this.ownerId);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        public UpdateInternalArticleRequestBody build() {
            return new UpdateInternalArticleRequestBody(id, title, body, authorId, ownerId, additionalProperties);
        }
    }
}
