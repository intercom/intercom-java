...
@JsonDeserialize(builder = DetachTagFromContactRequest.Builder.class)
public final class DetachTagFromContactRequest {
    ...
    private DetachTagFromContactRequest(String contactId, String id, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DetachTagFromContactRequest && equalTo((DetachTagFromContactRequest) other);
    }
    ...
    private boolean equalTo(DetachTagFromContactRequest other) {
    ...
    public interface ContactIdStage {
        ...
        Builder from(DetachTagFromContactRequest other);
    }
    ...
    public interface _FinalStage {
        DetachTagFromContactRequest build();
    }
    ...
    public static final class Builder implements ContactIdStage, IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DetachTagFromContactRequest other) {
        ...
        @java.lang.Override
        public DetachTagFromContactRequest build() {
            return new DetachTagFromContactRequest(contactId, id, additionalProperties);
        }
    }
}
