...
public final class GetCustomObjectInstancesByIdRequest {
    ...
    public static final class Builder implements CustomObjectTypeIdentifierStage, IdStage, _FinalStage {
        ...
        /**
         * The id or external_id of the custom object instance<p>The id or external_id of the custom object instance</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        @JsonSetter("id")
        ...
        public GetCustomObjectInstancesByIdRequest build() {
            return new GetCustomObjectInstancesByIdRequest(customObjectTypeIdentifier, id, additionalProperties);
        }
    }
}
