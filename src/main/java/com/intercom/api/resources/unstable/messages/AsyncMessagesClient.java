...
public class AsyncMessagesClient {
     ...
     */
    public CompletableFuture<WhatsappMessageStatusList> getWhatsAppMessageStatus(
            GetWhatsAppMessageStatusRequest request) {
        return this.rawClient.getWhatsAppMessageStatus(request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<WhatsappMessageStatusList> getWhatsAppMessageStatus(
        ...
        return this.rawClient.getWhatsAppMessageStatus(request, requestOptions).thenApply(response -> response.body());
    }
}
