...
@JsonDeserialize(builder = ListTagsForAContactRequest.Builder.class)
public final class ListTagsForAContactRequest {
    private final String contactId;

    private final Map<String, Object> additionalProperties;

    private ListTagsForAContactRequest(String contactId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListTagsForAContactRequest && equalTo((ListTagsForAContactRequest) other);
    }
    ...
    private boolean equalTo(ListTagsForAContactRequest other) {
    ...
    public interface ContactIdStage {
        ...
        Builder from(ListTagsForAContactRequest other);
    }

    public interface _FinalStage {
        ListTagsForAContactRequest build();
    }
    ...
    public static final class Builder implements ContactIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListTagsForAContactRequest other) {
        ...
        public ListTagsForAContactRequest build() {
            return new ListTagsForAContactRequest(contactId, additionalProperties);
        }
    }
}
