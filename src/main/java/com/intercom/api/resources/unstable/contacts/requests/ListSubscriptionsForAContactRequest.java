...
@JsonDeserialize(builder = ListSubscriptionsForAContactRequest.Builder.class)
public final class ListSubscriptionsForAContactRequest {
    private final String contactId;

    private final Map<String, Object> additionalProperties;

    private ListSubscriptionsForAContactRequest(String contactId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListSubscriptionsForAContactRequest
                && equalTo((ListSubscriptionsForAContactRequest) other);
    }
    ...
    private boolean equalTo(ListSubscriptionsForAContactRequest other) {
    ...
    public interface ContactIdStage {
        ...
        Builder from(ListSubscriptionsForAContactRequest other);
    }

    public interface _FinalStage {
        ListSubscriptionsForAContactRequest build();
    }
    ...
    public static final class Builder implements ContactIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListSubscriptionsForAContactRequest other) {
        ...
        public ListSubscriptionsForAContactRequest build() {
            return new ListSubscriptionsForAContactRequest(contactId, additionalProperties);
        }
    }
}
