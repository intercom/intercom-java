...
public class AsyncConversationsClient {
    ...
    public CompletableFuture<HandlingEventList> listHandlingEvents(ListHandlingEventsRequest request) {
        return this.rawClient.listHandlingEvents(request).thenApply(response -> response.body());
    }
     ...
     * <p>Requires the <code>read_conversations</code> OAuth scope.</p>
     */
    public CompletableFuture<HandlingEventList> listHandlingEvents(
            ListHandlingEventsRequest request, RequestOptions requestOptions) {
        return this.rawClient.listHandlingEvents(request, requestOptions).thenApply(response -> response.body());
    }
