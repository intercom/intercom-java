...
@JsonDeserialize(builder = DetachContactFromACompanyRequest.Builder.class)
public final class DetachContactFromACompanyRequest {
    ...
    private DetachContactFromACompanyRequest(String contactId, String id, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DetachContactFromACompanyRequest && equalTo((DetachContactFromACompanyRequest) other);
    }
    ...
    private boolean equalTo(DetachContactFromACompanyRequest other) {
    ...
    public interface ContactIdStage {
        ...
        Builder from(DetachContactFromACompanyRequest other);
    }
    ...
    public interface _FinalStage {
        DetachContactFromACompanyRequest build();
    }
    ...
    public static final class Builder implements ContactIdStage, IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DetachContactFromACompanyRequest other) {
        ...
        public DetachContactFromACompanyRequest build() {
            return new DetachContactFromACompanyRequest(contactId, id, additionalProperties);
        }
    }
}
