...
public class AsyncRawTicketTypesClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<TicketTypeList>> listTicketTypes() {
     ...
     * You can get a list of all ticket types for a workspace.
     */
    public CompletableFuture<IntercomHttpResponse<TicketTypeList>> listTicketTypes(RequestOptions requestOptions) {
        ...
        CompletableFuture<IntercomHttpResponse<TicketTypeList>> future = new CompletableFuture<>();
     ...
     * </blockquote>
     */
    public CompletableFuture<IntercomHttpResponse<Optional<TicketType>>> createTicketType(Object request) {
     ...
     * </blockquote>
     */
    public CompletableFuture<IntercomHttpResponse<Optional<TicketType>>> createTicketType(
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), new TypeReference<Optional<TicketType>>() {}),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Optional<TicketType>>> getTicketType(GetTicketTypeRequest request) {
     ...
     * You can fetch the details of a single ticket type.
     */
    public CompletableFuture<IntercomHttpResponse<Optional<TicketType>>> getTicketType(
