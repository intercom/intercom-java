...
public class AsyncRawWorkflowsClient {
     ...
     * {% /admonition %}</p>
     */
    public CompletableFuture<IntercomHttpResponse<WorkflowExport>> exportWorkflow(ExportWorkflowRequest request) {
     ...
     * {% /admonition %}</p>
     */
    public CompletableFuture<IntercomHttpResponse<WorkflowExport>> exportWorkflow(
        ...
        CompletableFuture<IntercomHttpResponse<WorkflowExport>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, WorkflowExport.class),
                                response));
                        return;
                    }
                    try {
