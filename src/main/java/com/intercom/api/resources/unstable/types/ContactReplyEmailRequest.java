...
public final class ContactReplyEmailRequest implements IContactReplyBaseRequest {
    ...
    public int hashCode() {
        return Objects.hash(
                this.body, this.createdAt, this.attachmentUrls, this.replyOptions, this.email, this.attachmentFiles);
    }
    ...
    public static final class Builder implements BodyStage, EmailStage, _FinalStage {
        ...
        public ContactReplyEmailRequest build() {
            return new ContactReplyEmailRequest(
                    body, createdAt, attachmentUrls, replyOptions, email, attachmentFiles, additionalProperties);
        }
    }
