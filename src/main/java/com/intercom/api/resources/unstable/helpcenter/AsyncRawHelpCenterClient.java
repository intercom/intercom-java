...
public class AsyncRawHelpCenterClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<CollectionList>> listAllCollections() {
     ...
     * <p>Collections will be returned in descending order on the <code>updated_at</code> attribute. This means if you need to iterate through results then we'll show the most recently updated collections first.</p>
     */
    public CompletableFuture<IntercomHttpResponse<CollectionList>> listAllCollections(RequestOptions requestOptions) {
        ...
        CompletableFuture<IntercomHttpResponse<CollectionList>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Collection>> createCollection(CreateCollectionRequest request) {
     ...
     * You can create a new collection by making a POST request to <code>https://api.intercom.io/help_center/collections.</code>
     */
    public CompletableFuture<IntercomHttpResponse<Collection>> createCollection(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Collection>> retrieveCollection(RetrieveCollectionRequest request) {
     ...
     * You can fetch the details of a single collection by making a GET request to <code>https://api.intercom.io/help_center/collections/&lt;id&gt;</code>.
     */
    public CompletableFuture<IntercomHttpResponse<Collection>> retrieveCollection(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Collection>> updateCollection(UpdateCollectionRequest request) {
     ...
     * You can update the details of a single collection by making a PUT request to <code>https://api.intercom.io/collections/&lt;id&gt;</code>.
     */
    public CompletableFuture<IntercomHttpResponse<Collection>> updateCollection(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<DeletedCollectionObject>> deleteCollection(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<HelpCenter>> retrieveHelpCenter(RetrieveHelpCenterRequest request) {
     ...
     * You can fetch the details of a single Help Center by making a GET request to <code>https://api.intercom.io/help_center/help_center/&lt;id&gt;</code>.
     */
    public CompletableFuture<IntercomHttpResponse<HelpCenter>> retrieveHelpCenter(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<HelpCenterList>> listHelpCenters() {
     ...
     * You can list all Help Centers by making a GET request to <code>https://api.intercom.io/help_center/help_centers</code>.
     */
    public CompletableFuture<IntercomHttpResponse<HelpCenterList>> listHelpCenters(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("help_center/help_centers")
                .build();
        ...
        CompletableFuture<IntercomHttpResponse<HelpCenterList>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
