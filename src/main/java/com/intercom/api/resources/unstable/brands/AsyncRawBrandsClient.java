...
public class AsyncRawBrandsClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<BrandList>> listBrands() {
     ...
     * The default brand id always matches the workspace
     */
    public CompletableFuture<IntercomHttpResponse<BrandList>> listBrands(RequestOptions requestOptions) {
        ...
        CompletableFuture<IntercomHttpResponse<BrandList>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), BrandList.class), response));
                        return;
                    }
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Brand>> retrieveBrand(RetrieveBrandRequest request) {
        return retrieveBrand(request, null);
    }

    /**
     * Fetches a specific brand by its unique identifier
     */
    public CompletableFuture<IntercomHttpResponse<Brand>> retrieveBrand(
            RetrieveBrandRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("brands")
        ...
        CompletableFuture<IntercomHttpResponse<Brand>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
