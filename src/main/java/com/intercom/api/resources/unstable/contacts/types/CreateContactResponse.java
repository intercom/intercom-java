...
@JsonDeserialize(builder = CreateContactResponse.Builder.class)
public final class CreateContactResponse implements IContact {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateContactResponse && equalTo((CreateContactResponse) other);
    }
    ...
    private boolean equalTo(CreateContactResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CreateContactResponse other) {
            type(other.getType());
            id(other.getId());
