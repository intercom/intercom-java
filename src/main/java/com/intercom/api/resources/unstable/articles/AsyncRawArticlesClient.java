...
public class AsyncRawArticlesClient {
     ...
     * </blockquote>
     */
    public CompletableFuture<IntercomHttpResponse<ArticleList>> listArticles() {
     ...
     * </blockquote>
     */
    public CompletableFuture<IntercomHttpResponse<ArticleList>> listArticles(RequestOptions requestOptions) {
        ...
        CompletableFuture<IntercomHttpResponse<ArticleList>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ArticleList.class), response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Article>> createArticle(Object request) {
        return createArticle(request, null);
    }

    /**
     * You can create a new article by making a POST request to <code>https://api.intercom.io/articles</code>.
     */
    public CompletableFuture<IntercomHttpResponse<Article>> createArticle(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Article>> retrieveArticle(RetrieveArticleRequest request) {
        return retrieveArticle(request, null);
    }

    /**
     * You can fetch the details of a single article by making a GET request to <code>https://api.intercom.io/articles/&lt;id&gt;</code>.
     */
    public CompletableFuture<IntercomHttpResponse<Article>> retrieveArticle(
            RetrieveArticleRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("articles")
     ...
     */
    public CompletableFuture<IntercomHttpResponse<DeletedArticleObject>> deleteArticle(DeleteArticleRequest request) {
        return deleteArticle(request, null);
    }

    /**
     * You can delete a single article by making a DELETE request to <code>https://api.intercom.io/articles/&lt;id&gt;</code>.
     */
    public CompletableFuture<IntercomHttpResponse<DeletedArticleObject>> deleteArticle(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<ArticleSearchResponse>> searchArticles() {
        return searchArticles(SearchArticlesRequest.builder().build());
    }
