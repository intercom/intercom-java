...
public class ContactsClient {
     ...
     * You can fetch a list of companies that are associated to a contact.
     */
    public ContactAttachedCompanies listCompaniesForAContact(
     ...
     * You can fetch a list of segments that are associated to a contact.
     */
    public ContactSegments listSegmentsForAContact(
     ...
     * 2.Opt-in subscription types that the user has opted-in to receiving.</p>
     */
    public SubscriptionTypeList listSubscriptionsForAContact(
