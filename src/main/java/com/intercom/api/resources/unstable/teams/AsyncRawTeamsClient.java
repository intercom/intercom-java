...
public class AsyncRawTeamsClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<TeamList>> listTeams() {
     ...
     * This will return a list of team objects for the App.
     */
    public CompletableFuture<IntercomHttpResponse<TeamList>> listTeams(RequestOptions requestOptions) {
        ...
        CompletableFuture<IntercomHttpResponse<TeamList>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Team>> retrieveTeam(RetrieveTeamRequest request) {
        return retrieveTeam(request, null);
    }

    /**
     * You can fetch the details of a single team, containing an array of admins that belong to this team.
     */
    public CompletableFuture<IntercomHttpResponse<Team>> retrieveTeam(
            RetrieveTeamRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("teams")
        ...
        CompletableFuture<IntercomHttpResponse<Team>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
