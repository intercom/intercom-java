...
public final class DeleteContentImportSourceRequest {
    ...
    private DeleteContentImportSourceRequest(String id, Map<String, Object> additionalProperties) {
        this.id = id;
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        public DeleteContentImportSourceRequest build() {
            return new DeleteContentImportSourceRequest(id, additionalProperties);
        }
    }
}
