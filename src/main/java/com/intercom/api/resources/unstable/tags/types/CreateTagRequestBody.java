...
@JsonDeserialize(using = CreateTagRequestBody.Deserializer.class)
public final class CreateTagRequestBody {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateTagRequestBody && equalTo((CreateTagRequestBody) other);
    }
    ...
    static final class Deserializer extends StdDeserializer<CreateTagRequestBody> {
        Deserializer() {
