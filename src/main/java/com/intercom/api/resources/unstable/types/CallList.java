...
@JsonDeserialize(builder = CallList.Builder.class)
public final class CallList {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CallList && equalTo((CallList) other);
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>Total number of items available.</p>
         */
        ...
        public CallList build() {
            return new CallList(type, data, totalCount, pages, additionalProperties);
        }
    }
}
