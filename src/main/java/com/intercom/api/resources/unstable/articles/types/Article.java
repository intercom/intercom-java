...
import com.intercom.api.resources.unstable.types.ArticleStatistics;
...
public final class Article implements IArticleListItem {
    ...
    public static final class Builder {
        ...
        public Builder statistics(Optional<ArticleStatistics> statistics) {
            this.statistics = statistics;
            return this;
        }

        public Builder statistics(ArticleStatistics statistics) {
