...
public class AsyncRawSwitchClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSwitchClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<Optional<PhoneSwitch>>> createPhoneSwitch(Object request) {
        return createPhoneSwitch(request, null);
    }
     ...
     * <p>If custom attributes are specified, they will be added to the user or lead's custom data attributes.</p>
     */
    public CompletableFuture<IntercomHttpResponse<Optional<PhoneSwitch>>> createPhoneSwitch(
