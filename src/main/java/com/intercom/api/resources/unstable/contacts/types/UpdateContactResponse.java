...
@JsonDeserialize(builder = UpdateContactResponse.Builder.class)
public final class UpdateContactResponse implements IContact {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateContactResponse && equalTo((UpdateContactResponse) other);
    }
    ...
    private boolean equalTo(UpdateContactResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateContactResponse other) {
            type(other.getType());
            id(other.getId());
