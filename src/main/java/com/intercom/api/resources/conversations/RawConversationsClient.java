...
public class RawConversationsClient {
     ...
     * <p>This will return the Message model that has been created.</p>
     */
    public IntercomHttpResponse<Message> create(CreateConversationRequest request, RequestOptions requestOptions) {
     ...
     * <p>For AI agent conversation metadata, please note that you need to have the agent enabled in your workspace, which is a <a href="https://www.intercom.com/help/en/articles/8205718-fin-resolutions#h_97f8c2e671">paid feature</a>.</p>
     */
    public IntercomHttpResponse<Conversation> find(FindConversationRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("conversations")
     ...
     * | $        | String                         | Ends With                                                    |</p>
     */
    public IntercomHttpResponse<SyncPagingIterable<Conversation>> search(
     ...
     */
    public IntercomHttpResponse<Conversation> reply(ReplyToConversationRequest request) {
     ...
     * You can reply to a conversation with a message from an admin or on behalf of a contact, or with a note for admins.
     */
    public IntercomHttpResponse<Conversation> reply(ReplyToConversationRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("conversations")
     ...
     * </ul>
     */
    public IntercomHttpResponse<Conversation> manage(ManageConversationPartsRequest request) {
     ...
     * </ul>
     */
    public IntercomHttpResponse<Conversation> manage(
     ...
     * {% /admonition %}</p>
     */
    public IntercomHttpResponse<Conversation> attachContactAsAdmin(
     ...
     * {% /admonition %}</p>
     */
    public IntercomHttpResponse<Conversation> detachContactAsAdmin(
     ...
     * {% /admonition %}</p>
     */
    public IntercomHttpResponse<Conversation> redactConversationPart(
    ...
    public IntercomHttpResponse<Void> runAssignmentRules(AutoAssignConversationRequest request) {
        return runAssignmentRules(request, null);
    }

    public IntercomHttpResponse<Void> runAssignmentRules(
