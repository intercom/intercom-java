...
@JsonDeserialize(builder = BlockContactRequest.Builder.class)
public final class BlockContactRequest {
    private final String contactId;

    private final Map<String, Object> additionalProperties;

    private BlockContactRequest(String contactId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BlockContactRequest && equalTo((BlockContactRequest) other);
    }
    ...
    private boolean equalTo(BlockContactRequest other) {
    ...
    public interface ContactIdStage {
        ...
        Builder from(BlockContactRequest other);
    }
    ...
    public static final class Builder implements ContactIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(BlockContactRequest other) {
        ...
        @java.lang.Override
        public BlockContactRequest build() {
            return new BlockContactRequest(contactId, additionalProperties);
        }
    }
}
