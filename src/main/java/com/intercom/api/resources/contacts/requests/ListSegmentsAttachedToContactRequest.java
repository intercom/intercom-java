...
@JsonDeserialize(builder = ListSegmentsAttachedToContactRequest.Builder.class)
public final class ListSegmentsAttachedToContactRequest {
    private final String contactId;

    private final Map<String, Object> additionalProperties;

    private ListSegmentsAttachedToContactRequest(String contactId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListSegmentsAttachedToContactRequest
                && equalTo((ListSegmentsAttachedToContactRequest) other);
    }
    ...
    private boolean equalTo(ListSegmentsAttachedToContactRequest other) {
    ...
    public static final class Builder implements ContactIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListSegmentsAttachedToContactRequest other) {
        ...
        public ListSegmentsAttachedToContactRequest build() {
            return new ListSegmentsAttachedToContactRequest(contactId, additionalProperties);
        }
    }
}
