...
@JsonDeserialize(builder = ListAttachedSubscriptionsRequest.Builder.class)
public final class ListAttachedSubscriptionsRequest {
    private final String contactId;

    private final Map<String, Object> additionalProperties;

    private ListAttachedSubscriptionsRequest(String contactId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListAttachedSubscriptionsRequest && equalTo((ListAttachedSubscriptionsRequest) other);
    }
    ...
    private boolean equalTo(ListAttachedSubscriptionsRequest other) {
    ...
    public interface _FinalStage {
        ListAttachedSubscriptionsRequest build();
    }
    ...
    public static final class Builder implements ContactIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListAttachedSubscriptionsRequest other) {
        ...
        public ListAttachedSubscriptionsRequest build() {
            return new ListAttachedSubscriptionsRequest(contactId, additionalProperties);
        }
    }
}
