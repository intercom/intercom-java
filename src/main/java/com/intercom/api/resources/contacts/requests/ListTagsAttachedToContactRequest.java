...
@JsonDeserialize(builder = ListTagsAttachedToContactRequest.Builder.class)
public final class ListTagsAttachedToContactRequest {
    private final String contactId;

    private final Map<String, Object> additionalProperties;

    private ListTagsAttachedToContactRequest(String contactId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListTagsAttachedToContactRequest && equalTo((ListTagsAttachedToContactRequest) other);
    }
    ...
    private boolean equalTo(ListTagsAttachedToContactRequest other) {
    ...
    public interface ContactIdStage {
        ...
        Builder from(ListTagsAttachedToContactRequest other);
    }

    public interface _FinalStage {
        ListTagsAttachedToContactRequest build();
    }
    ...
    public static final class Builder implements ContactIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListTagsAttachedToContactRequest other) {
        ...
        @java.lang.Override
        public ListTagsAttachedToContactRequest build() {
            return new ListTagsAttachedToContactRequest(contactId, additionalProperties);
        }
    }
}
