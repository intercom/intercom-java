...
public class AsyncRawContactsClient {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<SyncPagingIterable<Company>>> listAttachedCompanies(
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ContactAttachedCompanies parsedResponse =
                        ...
                        future.complete(new IntercomHttpResponse<>(
                                new SyncPagingIterable<Company>(true, result, parsedResponse, () -> {
                                    try {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<ContactSegments>> listAttachedSegments(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<SubscriptionTypeList>> listAttachedSubscriptions(
     ...
     */
    public CompletableFuture<IntercomHttpResponse<SubscriptionType>> attachSubscription(
    ...
    public CompletableFuture<IntercomHttpResponse<SubscriptionType>> attachSubscription(
        ...
        CompletableFuture<IntercomHttpResponse<SubscriptionType>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SubscriptionType.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<IntercomHttpResponse<SubscriptionType>> detachSubscription(
     ...
     * You can fetch a list of all tags that are attached to a specific contact.
     */
    public CompletableFuture<IntercomHttpResponse<TagList>> listAttachedTags(
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ContactsFindResponse.class),
                                response));
                        return;
                    }
                    try {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ContactsUpdateResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     * You can delete a single contact.
     */
    public CompletableFuture<IntercomHttpResponse<ContactDeleted>> delete(
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ContactsMergeLeadInUserResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     * | $        | String                           | Ends With                                                        |</p>
     */
    public CompletableFuture<IntercomHttpResponse<SyncPagingIterable<Contact>>> search(
        ...
        CompletableFuture<IntercomHttpResponse<SyncPagingIterable<Contact>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ContactList parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ContactList.class);
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new IntercomHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ContactsCreateResponse.class),
                                response));
                        return;
                    }
                    try {
     ...
     * You can archive a single contact.
     */
    public CompletableFuture<IntercomHttpResponse<ContactArchived>> archive(
     ...
     * You can unarchive a single contact.
     */
    public CompletableFuture<IntercomHttpResponse<ContactUnarchived>> unarchive(
