...
public class RawContactsClient {
     ...
     */
    public IntercomHttpResponse<SyncPagingIterable<Company>> listAttachedCompanies(
            ...
            if (response.isSuccessful()) {
                ...
                return new IntercomHttpResponse<>(
                        new SyncPagingIterable<Company>(
                                true, result, parsedResponse, () -> listAttachedCompanies(nextRequest, requestOptions)
                                        .body()),
                        response);
            }
            try {
     ...
     */
    public IntercomHttpResponse<ContactSegments> listAttachedSegments(ListSegmentsAttachedToContactRequest request) {
     ...
     * You can fetch a list of segments that are associated to a contact.
     */
    public IntercomHttpResponse<ContactSegments> listAttachedSegments(
     ...
     */
    public IntercomHttpResponse<SubscriptionTypeList> listAttachedSubscriptions(
     ...
     */
    public IntercomHttpResponse<SubscriptionType> attachSubscription(AttachSubscriptionToContactRequest request) {
     ...
     * <p>This will return a subscription type model for the subscription type that was added to the contact.</p>
     */
    public IntercomHttpResponse<SubscriptionType> attachSubscription(
     ...
     */
    public IntercomHttpResponse<SubscriptionType> detachSubscription(DetachSubscriptionFromContactRequest request) {
     ...
     * You can remove a specific subscription from a contact. This will return a subscription type model for the subscription type that was removed from the contact.
     */
    public IntercomHttpResponse<SubscriptionType> detachSubscription(
     ...
     */
    public IntercomHttpResponse<TagList> listAttachedTags(ListTagsAttachedToContactRequest request) {
     ...
     * You can fetch a list of all tags that are attached to a specific contact.
     */
    public IntercomHttpResponse<TagList> listAttachedTags(
    ...
    public IntercomHttpResponse<ContactsFindResponse> find(FindContactRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new IntercomHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ContactsFindResponse.class), response);
            }
            try {
     ...
     */
    public IntercomHttpResponse<ContactDeleted> delete(DeleteContactRequest request) {
    ...
    public IntercomHttpResponse<ContactsMergeLeadInUserResponse> mergeLeadInUser(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new IntercomHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ContactsMergeLeadInUserResponse.class),
                        response);
            }
            try {
                if (response.code() == 401) {
     ...
     * | $        | String                           | Ends With                                                        |</p>
     */
    public IntercomHttpResponse<SyncPagingIterable<Contact>> search(SearchRequest request) {
     ...
     * | $        | String                           | Ends With                                                        |</p>
     */
    public IntercomHttpResponse<SyncPagingIterable<Contact>> search(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            if (response.isSuccessful()) {
                ContactList parsedResponse = ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ContactList.class);
                ...
                return new IntercomHttpResponse<>(
                        new SyncPagingIterable<Contact>(startingAfter.isPresent(), result, parsedResponse, () -> search(
     ...
     * {% /admonition %}
     */
    public IntercomHttpResponse<SyncPagingIterable<Contact>> list() {
     ...
     * {% /admonition %}
     */
    public IntercomHttpResponse<SyncPagingIterable<Contact>> list(ListContactsRequest request) {
     ...
     */
    public IntercomHttpResponse<ContactArchived> archive(ArchiveContactRequest request) {
     ...
     */
    public IntercomHttpResponse<ContactUnarchived> unarchive(UnarchiveContactRequest request) {
     ...
     * You can unarchive a single contact.
     */
    public IntercomHttpResponse<ContactUnarchived> unarchive(
