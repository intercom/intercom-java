...
public final class RequestOptions {
    ...
    /**
     * version.get().toString() is sent as the "Intercom-Version" header, overriding client options if present.
     */
    ...
    public Map<String, String> getHeaders() {
        ...
        if (this.version.isPresent()) {
            headers.put("Intercom-Version", this.version.get().toString());
        }
        if (this.token != null) {
