...
@JsonDeserialize(builder = CheckboxOption.Builder.class)
public final class CheckboxOption {
    ...
    /**
     * @return The text shown next to the checkbox.
     */
    @JsonProperty("text")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CheckboxOption && equalTo((CheckboxOption) other);
    }
    ...
    private boolean equalTo(CheckboxOption other) {
    ...
    public interface IdStage {
        ...
        Builder from(CheckboxOption other);
    }
    ...
    public static final class Builder implements IdStage, TextStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CheckboxOption other) {
            id(other.getId());
            text(other.getText());
        ...
        /**
         * The text shown next to the checkbox.<p>The text shown next to the checkbox.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        @JsonSetter("text")
        ...
        public CheckboxOption build() {
            return new CheckboxOption(id, text, disabled, additionalProperties);
        }
    }
}
