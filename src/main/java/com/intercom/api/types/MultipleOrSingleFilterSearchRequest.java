...
@JsonDeserialize(using = MultipleOrSingleFilterSearchRequest.Deserializer.class)
public final class MultipleOrSingleFilterSearchRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MultipleOrSingleFilterSearchRequest
                && equalTo((MultipleOrSingleFilterSearchRequest) other);
    }
    ...
    static final class Deserializer extends StdDeserializer<MultipleOrSingleFilterSearchRequest> {
        Deserializer() {
            super(MultipleOrSingleFilterSearchRequest.class);
        }

        @java.lang.Override
        public MultipleOrSingleFilterSearchRequest deserialize(JsonParser p, DeserializationContext context)
                throws IOException {
