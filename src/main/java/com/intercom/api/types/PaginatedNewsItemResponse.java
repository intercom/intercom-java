...
@JsonDeserialize(builder = PaginatedNewsItemResponse.Builder.class)
public final class PaginatedNewsItemResponse {
    ...
    private PaginatedNewsItemResponse(
    ...
    /**
     * @return A count of the total number of News Items.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaginatedNewsItemResponse && equalTo((PaginatedNewsItemResponse) other);
    }
    ...
    private boolean equalTo(PaginatedNewsItemResponse other) {
    ...
    public interface _FinalStage {
        PaginatedNewsItemResponse build();
        ...
        _FinalStage addAllData(List<NewsItem> data);
    }
    ...
    public static final class Builder implements TotalCountStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PaginatedNewsItemResponse other) {
         ...
         */
        @java.lang.Override
        public _FinalStage addAllData(List<NewsItem> data) {
         ...
         */
        @java.lang.Override
        public _FinalStage addData(NewsItem data) {
            this.data.add(data);
            return this;
        }
        ...
        @java.lang.Override
        public PaginatedNewsItemResponse build() {
            return new PaginatedNewsItemResponse(pages, totalCount, data, additionalProperties);
        }
    }
}
