...
@JsonDeserialize(using = Datetime.Deserializer.class)
public final class Datetime {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof Datetime && equalTo((Datetime) other);
    }
    ...
    static final class Deserializer extends StdDeserializer<Datetime> {
        Deserializer() {
