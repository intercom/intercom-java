...
@JsonDeserialize(builder = ContactTags.Builder.class)
public final class ContactTags {
    ...
    /**
     * @return This object represents the tags attached to a contact.
     */
    @JsonProperty("data")
    ...
    /**
     * @return url to get more tag resources for this contact
     */
    @JsonProperty("url")
    ...
    /**
     * @return Int representing the total number of tags attached to this contact
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ContactTags && equalTo((ContactTags) other);
    }
    ...
    private boolean equalTo(ContactTags other) {
    ...
    public interface UrlStage {
        ...
        Builder from(ContactTags other);
    }
    ...
    public interface _FinalStage {
        ...
        /**
         * <p>This object represents the tags attached to a contact.</p>
         */
    ...
    public static final class Builder implements UrlStage, TotalCountStage, HasMoreStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ContactTags other) {
            data(other.getData());
            url(other.getUrl());
        ...
        /**
         * url to get more tag resources for this contact<p>url to get more tag resources for this contact</p>
        ...
        /**
         * Int representing the total number of tags attached to this contact<p>Int representing the total number of tags attached to this contact</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        ...
        public ContactTags build() {
            return new ContactTags(data, url, totalCount, hasMore, additionalProperties);
        }
    }
}
